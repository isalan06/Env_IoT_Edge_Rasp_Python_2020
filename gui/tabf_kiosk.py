...
if bOpenTestForm == True:
    ...
    _id_label = Text(app2, text="身分證:", size=20, font="Times New Roman", color="black", grid = [0,1], align="left")
    _id_text =  Text(app2, text="0000000000", size=20, font="Times New Roman", color="blue", grid = [1,1], align="left")
    _temperature_label = Text(app2, text="   溫度(C): ", size=20, font="Times New Roman", color="black", grid = [2,1], align="left")
    _temperature_text =  Text(app2, text="0.0", size=20, font="Times New Roman", color="blue", grid = [3,1], align="left")
    _time_label = Text(app2, text="時間:", size=20, font="Times New Roman", color="black", grid = [0,2], align="left")
    _time_text =  Text(app2, text="NA", size=20, font="Times New Roman", color="blue", grid = [1,2], align="left")
